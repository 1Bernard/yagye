    ...
    class IndexView < ApplicationComponent
      ...
      def stat_band
        render UI::Grid.new(columns: 4) do
          stat_cell("Total paid (MTD)",   "GHS 0.00", icon: :trending_up,  color: "#16a34a", tint: "rgba(22,163,74,0.08)")
          stat_cell("In-flight",          "0",         icon: :clock,        color: "#d97706", tint: "rgba(217,119,6,0.08)")
          stat_cell("Next scheduled",     "—",         icon: :calendar,     color: "#3D47F5", tint: "rgba(61,71,245,0.08)")
          stat_cell("Failed (30d)",       "0",         icon: :alert_circle, color: "#dc2626", tint: "rgba(220,38,38,0.08)")
        end
      end
